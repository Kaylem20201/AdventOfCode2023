    ...
    for (const currentSet of orderedMapSet) {
        for (const map of currentSet) {
            ...
            if (map.sourceStart + map.range <= currentResult)
                continue;
            console.log('Found route. Current: %d, SourceStart: %d, DestinationStart: %d, Range: %d', currentResult, map.sourceStart, map.destinationStart, map.range);
